...
#ifndef SRC_FSMSIMPLE_MAINFSM_OPERATION3_STATE_H_
#define SRC_FSMSIMPLE_MAINFSM_OPERATION3_STATE_H_

#include "wsbasestate.h"

class Operation_State3 : public WSBaseState3 {
public:
...
#endif /* SRC_FSMSIMPLE_MAINFSM_Operation_State3_H_ */
