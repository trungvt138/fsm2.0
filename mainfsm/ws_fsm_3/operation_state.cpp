...
void Operation_State3::entry() {
    std::cout << "\nWSFsm3: Operation State" << std::endl;
}

void Operation_State3::exit() {
    action->ak_l_grn1_off();
    action->ak_l_grn2_off();
}

void Operation_State3::resetDeepHistory() {
    leavingState();
    opstatemachine->exit();
    new(this) WSIdle3;
...
void Operation_State3::handleDefaultExit(const TriggerProcessingState &processingstate) {
...
void Operation_State3::enterByDefaultEntryPoint() {
    entry();
...
TriggerProcessingState Operation_State3::ss_ls_str1_interrupted() {
...
TriggerProcessingState Operation_State3::ss_ls_str1_continuous() {
...
TriggerProcessingState Operation_State3::lightbarrier_height1_interrupted() {
...
TriggerProcessingState Operation_State3::lightbarrier_height1_continuous() {
...
TriggerProcessingState Operation_State3::height_ok1_active() {
...
TriggerProcessingState Operation_State3::height_ok1_unactive() {
...
TriggerProcessingState Operation_State3::ss_ls_srt1_interrupted() {
...
TriggerProcessingState Operation_State3::ss_ls_srt1_continuous() {
...
TriggerProcessingState Operation_State3::ss_ms1_erkannt() {
...
TriggerProcessingState Operation_State3::ss_ms1_fall() {
...
TriggerProcessingState Operation_State3::switch1_open() {
...
TriggerProcessingState Operation_State3::switch1_unopen() {
...
TriggerProcessingState Operation_State3::ss_ls_sli1_full() {
...
TriggerProcessingState Operation_State3::ss_ls_sli1_rise() {
...
TriggerProcessingState Operation_State3::ss_ls_end1_continuous() {
...
TriggerProcessingState Operation_State3::ss_ls_end1_interrupted() {
...
TriggerProcessingState Operation_State3::ss_t_str1_pressed() {
...
TriggerProcessingState Operation_State3::ss_t_str1_unpressed() {
...
TriggerProcessingState Operation_State3::ss_t_stp1_unpressed() {
...
TriggerProcessingState Operation_State3::ss_t_rst1_pressed() {
...
TriggerProcessingState Operation_State3::ss_t_rst1_unpressed() {
...
TriggerProcessingState Operation_State3::ss_t_str1_shortpressed() {
...
TriggerProcessingState Operation_State3::ws_sorted_FBA1() {
...
TriggerProcessingState Operation_State3::ss_ls_str2_interrupted() {
...
TriggerProcessingState Operation_State3::ss_ls_str2_continuous() {
...
TriggerProcessingState Operation_State3::lightbarrier_height2_interrupted() {
...
TriggerProcessingState Operation_State3::lightbarrier_height2_continuous() {
...
TriggerProcessingState Operation_State3::height_ok2_active() {
...
TriggerProcessingState Operation_State3::height_ok2_unactive() {
...
TriggerProcessingState Operation_State3::ss_ls_srt2_interrupted() {
...
TriggerProcessingState Operation_State3::ss_ls_srt2_continuous() {
...
TriggerProcessingState Operation_State3::ss_ms2_erkannt() {
...
TriggerProcessingState Operation_State3::ss_ms2_fall() {
...
TriggerProcessingState Operation_State3::switch2_open() {
...
TriggerProcessingState Operation_State3::switch2_unopen() {
...
TriggerProcessingState Operation_State3::ss_ls_sli2_full() {
...
TriggerProcessingState Operation_State3::ss_ls_sli2_rise() {
...
TriggerProcessingState Operation_State3::ss_ls_end2_continuous() {
...
TriggerProcessingState Operation_State3::ss_ls_end2_interrupted() {
...
TriggerProcessingState Operation_State3::ss_t_str2_pressed() {
...
TriggerProcessingState Operation_State3::ss_t_str2_unpressed() {
...
TriggerProcessingState Operation_State3::ss_t_stp2_unpressed() {
...
TriggerProcessingState Operation_State3::ss_t_rst2_pressed() {
...
TriggerProcessingState Operation_State3::ss_t_rst2_unpressed() {
    std::cout << "Operation_State2::ss_t_rst1_unpressed called" << std::endl;
...
TriggerProcessingState Operation_State3::ss_t_str2_shortpressed() {
...
TriggerProcessingState Operation_State3::ws_sorted_FBA2() {
...
TriggerProcessingState Operation_State3::slide1_free() {
...
TriggerProcessingState Operation_State3::slide2_free() {
...
TriggerProcessingState Operation_State3::right_order() {
...
TriggerProcessingState Operation_State3::unwanted_ws() {
...
TriggerProcessingState Operation_State3::height_calibration() {
...
TriggerProcessingState Operation_State3::height_high() {
...
TriggerProcessingState Operation_State3::height_flat() {
...
TriggerProcessingState Operation_State3::height_hole() {
...
TriggerProcessingState Operation_State3::height_band() {
...
void Operation_State3::showState() {
    std::cout << "      WSFsm3: Operation State" << std::endl;
    opstatemachine->showState();
}

void Operation_State3::enterByDeepHistoryEntryPoint() {
    entry();
    opstatemachine->enterViaDeepHistory();
}
